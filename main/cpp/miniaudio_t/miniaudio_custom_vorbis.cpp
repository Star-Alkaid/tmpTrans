...
void miniaudio_custom_vorbis::customVorbisDeviceInit(){
    ...
    */
    ...
    result = ma_decoder_init_file(g_filePath_ogg_custom_v, &decoderConfig, &decoder);
    if (result != MA_SUCCESS) {
    ...
    if (result != MA_SUCCESS) {
        LOGE("Failed to retrieve decoder data format.");
...
void miniaudio_custom_vorbis::customVorbisDevicePlay(){
    if (ma_device_start(&device) != MA_SUCCESS) {
        LOGE("Failed to start playback device.\n");
...
void miniaudio_custom_vorbis::customVorbisDeviceStop(){
...
miniaudio_custom_vorbis::~miniaudio_custom_vorbis(){
    ma_device_uninit(&device);
    ma_decoder_uninit(&decoder);
}